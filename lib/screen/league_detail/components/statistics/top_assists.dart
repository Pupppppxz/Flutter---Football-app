...
import 'package:footballapp/screen/league_detail/components/tableBody.dart/top_assist.dart';
import 'package:footballapp/screen/league_detail/components/tableBody.dart/top_score.dart';

import '../../../../constant.dart';

class TopAssistsScreen extends StatelessWidget {
...
class BodyStatistic extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: dataTopAsstisBody(title2: title2, color: color, type: type),
    );
  }
}
