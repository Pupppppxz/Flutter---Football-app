...
import 'package:footballapp/screen/league_detail/components/tableBody.dart/top_red_card.dart';
import 'package:footballapp/screen/league_detail/components/tableBody.dart/top_score.dart';

import '../../../../constant.dart';

class TopRedCardScreen extends StatelessWidget {
  final String type, title1, title2;
  final Color color;
  const TopRedCardScreen(
    param0, {
    Key? key,
    required this.type,
...
class BodyStatistic extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: dataTopRedCardBody(title2: title2, color: color, type: type),
    );
  }
}
